...
> [!IMPORTANT]
> This assumes that the reader has some significant experience with programming, i will not be explaining how to write software. The tutorial will be in C, simple enough while being low level for some of the things well do. I recommend reading : <a href="https://www.amazon.com/Programming-Language-2nd-Brian-Kernighan/dp/0131103628">The C Programming Language, 2nd Edition, by Brian W. Kernighan and Dennis M. Ritchie (Prentice Hall, 1988).</a>
