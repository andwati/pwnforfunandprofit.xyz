!(function (e, t) {
  ...
  return (function () {
    ...
    var r = function e(t, r) {
      ...
      if (o && o.start <= o.end) {
        ...
        i +=
          ...
          l +
          (a + 15 < s.length ? s.slice(a, a + 15) + '\u2026' : s.slice(a));
      }
      var h = new Error(i);
      return (
        (h.name = 'ParseError'),
              ...
              this._fontMetrics ||
                (this._fontMetrics = (function (e) {
                  ...
                  if (!q[(t = e >= 5 ? 0 : e >= 3 ? 1 : 2)]) {
                    var r = (q[t] = { cssEmPerMu: B.quad[t] / 18 });
        ...
        return (
          ...
          (t.toNode = function () {
            ...
            for (var r in (this.italic > 0 &&
              ((t = document.createElement('span')).style.marginRight = F(this.italic)),
    ...
    (ie(oe, le, be, '\u2261', '\\equiv', !0),
      ...
      ie(oe, le, me, '\u22c5', '\\cdot', !0),
      ie(oe, le, me, '\u2218', '\\circ', !0),
      ie(oe, le, me, '\xf7', '\\div', !0),
      ie(oe, le, me, '\xb1', '\\pm', !0),
      ie(oe, le, me, '\xd7', '\\times', !0),
      ie(oe, le, me, '\u2229', '\\cap', !0),
      ie(oe, le, me, '\u222a', '\\cup', !0),
    ...
    var Ve = [
      ...
      Fe = function (e, t, r) {
        return (
          ae[r][e] && ae[r][e].replace && (e = ae[r][e].replace),
          { value: e, metrics: N(e, t, r) }
        );
      },
      ...
      Ke = {
        ...
        mathsym: function (e, t, r, n) {
          return (
            void 0 === n && (n = []),
            'boldsymbol' === r.font && Fe(e, 'Main-Bold', t).metrics
    ...
    var lt = function (e) {
      ...
      ft = function (e, t, r, n) {
        ...
        if (1 === e.length) {
          var c = e[0];
          'sizing' === c.type
            ? (h = t.havingSize(c.size))
            : 'styling' === c.type && (h = t.havingStyle(pt[c.style]));
        }
          ...
          gt(
            ...
            function (e, t) {
              ...
              'mbin' === r && l.contains(ut, n)
                ? (t.classes[0] = 'mord')
                : 'mbin' === n && l.contains(mt, r) && (e.classes[0] = 'mord');
            },
            { node: m },
            u,
            p,
    ...
    function kt(e, t) {
      var r = ct(['base'], e, t),
        n = ct(['strut']);
      return (
        (n.style.height = F(r.height + r.depth)),
      ...
      Pt = function (e, t, r, n, a) {
        ...
        if (/fbox|color|angl/.test(t)) {
          ...
          (/^[bx]cancel$/.test(t) &&
            ...
            /^x?cancel$/.test(t) &&
              l.push(
                new Q({ x1: '0', y1: '100%', x2: '100%', y2: '0', 'stroke-width': '0.046em' }),
              ));
          var h = new K(l, { width: '100%', height: F(o) });
      ...
      Gt = function (e, t) {
        var r = (function () {
            ...
            if (l.contains(['widehat', 'widecheck', 'widetilde', 'utilde'], n)) {
              ...
              return { span: Ke.makeSvgSpan([], [m], t), minWidth: 0, height: o };
            }
            var u,
              p,
              d,
            ...
            (h = Ke.makeVList(
              {
                ...
                children: [
                  { type: 'elem', elem: i },
                  {
                    ...
                    wrapperStyle:
                      o > 0
                        ? { width: 'calc(100% - ' + F(2 * o) + ')', marginLeft: F(2 * o) }
                        : void 0,
                  },
                ],
              },
    ...
    (ot({
      ...
      ot({
        ...
        handler: function (e, t) {
          return { type: 'pmb', mode: e.parser.mode, mclass: Qt(t[0]), body: ht(t[0]) };
        },
        htmlBuilder: function (e, t) {
          var r = ft(e.body, t, !0),
    ...
    (ot({
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          ...
          return (
            e.newLine &&
              (r.classes.push('newline'), e.size && (r.style.marginTop = F(P(e.size, t)))),
            r
          );
        },
        mathmlBuilder: function (e, t) {
    ...
    (ot({
      ...
      handler: function (e) {
        ...
        if (ir[a.text])
          return (
            ('\\global' !== r && '\\\\globallong' !== r) || (a.text = ir[a.text]),
    ...
    var lr = function (e, t, r) {
      ...
      mr = function (e, t, r, n, a, i) {
        var o = (function (e, t, r, n) {
          ...
          s = hr(Ke.makeSpan(['delimsizing', 'size' + t], [o], n), x.TEXT, n, i);
        return (r && cr(s, n, x.TEXT), s);
      },
      ur = function (e, t, r) {
        var n;
        return (
      ...
      vr = function (e, t, r, n, a, i) {
        ...
        if (m.length > 0) {
          var C = z - f - y,
            ...
            O = new K([I], { width: R, height: H, viewBox: '0 0 ' + u + ' ' + N }),
        ...
        return hr(Ke.makeSpan(['delimsizing', 'mult'], [P], V), x.TEXT, n, i);
      },
      br = 0.08,
      ...
      Cr = function (e, t, r, n, a, i) {
        ...
        ('<' === e || '\\lt' === e || '\u27e8' === e
          ? (e = '\\langle')
          : ('>' !== e && '\\gt' !== e && '\u27e9' !== e) || (e = '\\rangle'),
          (o = l.contains(kr, e) ? Mr : l.contains(xr, e) ? Ar : zr));
        var s = Br(e, t, o, n);
        return 'small' === s.type
        ...
        sizedDelim: function (e, t, r, a, i) {
          if (
            ('<' === e || '\\lt' === e || '\u27e8' === e
              ? (e = '\\langle')
              : ('>' !== e && '\\gt' !== e && '\u27e9' !== e) || (e = '\\rangle'),
            l.contains(xr, e) || l.contains(kr, e))
          )
            return mr(e, t, !1, r, a, i);
          if (l.contains(wr, e)) return vr(e, Sr[t], !1, r, a, i);
    ...
    function Rr(e, t) {
      var r = Xt(e);
      if (r && l.contains(Ir, r.text)) return r;
      throw new n(
        r
    ...
    (ot({
      ...
      htmlBuilder: function (e, t) {
        return '.' === e.delim
          ...
          : Nr.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]);
      },
      mathmlBuilder: function (e) {
        ...
        var n = F(Nr.sizeToMaxHeight[e.size]);
        ...
        htmlBuilder: function (e, t) {
          ...
          if (
            ...
            (r =
              '.' === e.left
                ? xt(t, ['mopen'])
                : Nr.leftRightDelim(e.left, i, o, t, e.mode, ['mopen'])),
            a.unshift(r),
            s)
          )
            for (var h = 1; h < a.length; h++) {
              var c = a[h].isMiddle;
              c && (a[h] = Nr.leftRightDelim(c.delim, i, o, c.options, e.mode, []));
            }
          if ('.' === e.right) n = xt(t, ['mclose']);
          else {
            var m = e.rightColor ? t.withColor(e.rightColor) : t;
            n = Nr.leftRightDelim(e.right, i, o, m, e.mode, ['mclose']);
          }
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          ...
          if ('.' === e.delim) r = xt(t, []);
            ...
            r = Nr.sizedDelim(e.delim, 1, t, e.mode, []);
    ...
    var Or = function (e, t) {
        ...
        if ('sout' === o)
          ...
          var m = P({ number: 0.6, unit: 'pt' }, t),
            u = P({ number: 0.35, unit: 'ex' }, t);
          ...
          (/box/.test(o)
            ...
            /fbox|boxed|fcolorbox/.test(o)
              ? ((r.style.borderStyle = 'solid'), (r.style.borderWidth = F(y)))
              : 'angl' === o &&
                0.049 !== y &&
                ((r.style.borderTopWidth = F(y)), (r.style.borderRightWidth = F(y))),
            (h = i.depth + b),
            e.backgroundColor &&
      ...
      function w() {
        y &&
          (e.gullet.macros.get('\\df@tag')
            ? (y.push(e.subparse([new Gr('\\df@tag')])),
    ...
    var jr = function (e, t) {
        ...
        var d = 'CD' === e.colSeparationType ? P({ number: 3, unit: 'ex' }, t) : 12 * u,
          f = 3 * u,
          g = e.arraystretch * d,
          v = 0.7 * g,
          b = 0.3 * g,
          ...
          for (r = 0; r < i; ++r) {
            ...
            (((D =
              !0 === L
                ...
                : !1 === L
                  ? Ke.makeSpan([], [], t)
                  : Ke.makeSpan([], ft(L, t, !0), t)).depth = O.depth),
              (D.height = O.height),
        ...
        for (a = 0, N = 0; a < s || N < I.length; ++a, ++N) {
          for (var V = I[N] || {}, G = !0; 'separator' === V.type; ) {
            if (
              (G ||
                (((C = Ke.makeSpan(['arraycolsep'], [])).style.width = F(
          ...
          if (!(a >= s)) {
            ...
            (a > 0 || e.hskipBeforeAndAfter) &&
              0 !== (W = l.deflt(V.pregap, p)) &&
              (((C = Ke.makeSpan(['arraycolsep'], [])).style.width = F(W)), R.push(C));
            var _ = [];
            for (r = 0; r < i; ++r) {
              var j = h[r],
                $ = j[a];
            ...
            ((_ = Ke.makeVList({ positionType: 'individualShift', children: _ }, t)),
              ...
              (a < s - 1 || e.hskipBeforeAndAfter) &&
                0 !== (W = l.deflt(V.postgap, p)) &&
                (((C = Ke.makeSpan(['arraycolsep'], [])).style.width = F(W)), R.push(C)));
          }
        }
        if (((h = Ke.makeSpan(['mtable'], R)), c.length > 0)) {
          for (
            var K = Ke.makeLineSpan('hline', t, m),
              J = Ke.makeLineSpan('hdashline', t, m),
      ...
      Zr = function (e, t) {
        ...
        if (e.cols && e.cols.length > 0) {
          var p = e.cols,
            ...
            g = 0,
            v = p.length;
          ('separator' === p[0].type && ((m += 'top '), (g = 1)),
            'separator' === p[p.length - 1].type && ((m += 'bottom '), (v -= 1)));
          for (var b = g; b < v; b++)
            'align' === p[b].type
              ? ((u += $r[p[b].align]), f && (d += 'none '), (f = !0))
              : 'separator' === p[b].type &&
                f &&
    ...
    (Dr({
      ...
      Dr({
        ...
        props: { numArgs: 0 },
        handler: function (e) {
          l.contains(['gather', 'gather*'], e.envName) && Yr(e);
          var t = {
          ...
          return (
            ...
            (function (e) {
              ...
              for (var a, i, o = [], s = [o], l = 0; l < t.length; l++) {
                for (
                  var h = t[l],
                    c = { type: 'styling', body: [], mode: 'math', style: 'display' },
                    m = 0;
                  m < h.length;
                  m++
                )
    ...
    var rn = function (e, t) {
      ...
      nn = function (e, t) {
        ...
        if (
          (e.hasBarLine
            ? (e.barSize
                ? ((c = P(e.barSize, t)), (h = Ke.makeLineSpan('frac-line', t, c)))
          ...
          n.size === x.DISPLAY.size || 'display' === e.size
            ...
            : (c > 0
                ? ((u = t.fontMetrics().num2), (p = m))
                : ((u = t.fontMetrics().num3), (p = 3 * m)),
              (d = t.fontMetrics().denom2)),
          h)
        ) {
          var w = t.fontMetrics().axisHeight;
          (u - o.depth - (w + 0.5 * c) < p && (u += p - (u - o.depth - (w + 0.5 * c))),
            w - 0.5 * c - (y.height - d) < p && (d += p - (w - 0.5 * c - (y.height - d))));
          var k = -(w - 0.5 * c);
          f = Ke.makeVList(
            {
              positionType: 'individualShift',
        ...
        return (
          ...
          (v =
            null == e.leftDelim
              ? xt(t, ['mopen'])
              : Nr.customSizedDelim(e.leftDelim, g, !0, t.havingStyle(n), e.mode, ['mopen'])),
          (b = e.continued
            ? Ke.makeSpan([])
            : null == e.rightDelim
              ? xt(t, ['mclose'])
              : Nr.customSizedDelim(e.rightDelim, g, !0, t.havingStyle(n), e.mode, ['mclose'])),
      ...
      mathmlBuilder: function (e, t) {
        ...
        if (
          (e.totalheight.number > 0 &&
            ((a = P(e.totalheight, t) - n), r.setAttribute('valign', F(-a))),
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          ...
          var n = Ke.makeSpan(['fix'], []),
            ...
            i = Ke.makeSpan(['strut']);
          return (
            (i.style.height = F(a.height + a.depth)),
    ...
    var mn = function (e, t, r, n, a, i, o) {
          ...
          c = Ke.makeVList(
            {
              ...
              children: [
                ...
                { type: 'elem', elem: s.elem, marginLeft: F(-i) },
                { type: 'kern', size: s.kern },
                { type: 'elem', elem: e },
                { type: 'kern', size: h.kern },
                { type: 'elem', elem: h.elem, marginLeft: F(i) },
                { type: 'kern', size: n.fontMetrics().bigOpSpacing5 },
              ],
            },
            n,
      ...
      pn = function (e, t) {
        ...
        if (
          ...
          if (
            (('\\oiint' !== a.name && '\\oiiint' !== a.name) ||
              ((m = a.name.slice(1)), (a.name = 'oiint' === m ? '\\iint' : '\\iiint')),
            (o = Ke.makeSymbol(a.name, c, 'math', t, [
              'mop',
              'op-symbol',
              h ? 'large-op' : 'small-op',
            ])),
        ...
        return (
          ...
          i
            ? mn(o, r, n, t, s, b, v)
            : (v && ((o.style.position = 'relative'), (o.style.top = F(v))), o)
        );
      },
      dn = function (e, t) {
        var r;
    ...
    (ot({
      ...
      Pr('\\operatorname', '\\@ifstar\\operatornamewithlimits\\operatorname@'),
      st({
        type: 'ordgroup',
        htmlBuilder: function (e, t) {
          return e.semisimple
      ...
      ot({
        ...
        mathmlBuilder: function (e, t) {
          ...
          return (
            a >= 0
              ? s.setAttribute('height', F(a))
              : (s.setAttribute('height', F(a)), s.setAttribute('depth', F(-a))),
    ...
    (st({
      ...
      htmlBuilder: function (e, t) {
        ...
        if (n && a) {
          ((u = Math.max(u, i, n.depth + 0.25 * m.xHeight)), (p = Math.max(p, m.sub2)));
          ...
          p = Math.max(p, m.sub1, a.height - 0.8 * m.xHeight);
      ...
      Ln = (function () {
        function e(e, t) {
          ((this.input = void 0),
            ...
            (this.input = e),
            (this.settings = t),
            (this.tokenRegex = new RegExp(En, 'g')),
            (this.catcodes = { '%': 14, '~': 13 }));
        }
        var t = e.prototype;
        return (
    ...
    (Pr('\\noexpand', function (e) {
      ...
      Pr('\\@ifstar', '\\@ifnextchar *{\\@firstoftwo{#1}}'),
      Pr('\\TextOrMath', function (e) {
    ...
    (Pr('\\newcommand', function (e) {
      ...
      Pr('\\aa', '\\r a'),
      Pr('\\AA', '\\r A'),
      Pr('\\textcopyright', '\\html@mathml{\\textcircled{c}}{\\char`\xa9}'),
      Pr('\\copyright', '\\TextOrMath{\\textcopyright}{\\text{\\textcopyright}}'),
      Pr('\\textregistered', '\\html@mathml{\\textcircled{\\scriptsize R}}{\\char`\xae}'),
      Pr('\u212c', '\\mathscr{B}'),
      Pr('\u2130', '\\mathscr{E}'),
      Pr('\u2131', '\\mathscr{F}'),
      Pr('\u210b', '\\mathscr{H}'),
      ...
      Pr('\\Bbbk', '\\Bbb{k}'),
      Pr('\xb7', '\\cdotp'),
      Pr('\\llap', '\\mathllap{\\textrm{#1}}'),
      Pr('\\rlap', '\\mathrlap{\\textrm{#1}}'),
      Pr('\\clap', '\\mathclap{\\textrm{#1}}'),
      Pr('\\mathstrut', '\\vphantom{(}'),
      Pr('\\underbar', '\\underline{\\text{#1}}'),
      ...
      Pr('\u2259', '\\html@mathml{\\stackrel{\\tiny\\wedge}{=}}{\\mathrel{\\char`\u2258}}'),
      Pr('\u225a', '\\html@mathml{\\stackrel{\\tiny\\vee}{=}}{\\mathrel{\\char`\u225a}}'),
      Pr('\u225b', '\\html@mathml{\\stackrel{\\scriptsize\\star}{=}}{\\mathrel{\\char`\u225b}}'),
      Pr('\u225d', '\\html@mathml{\\stackrel{\\tiny\\mathrm{def}}{=}}{\\mathrel{\\char`\u225d}}'),
      Pr('\u225e', '\\html@mathml{\\stackrel{\\tiny\\mathrm{m}}{=}}{\\mathrel{\\char`\u225e}}'),
      Pr('\u225f', '\\html@mathml{\\stackrel{\\tiny?}{=}}{\\mathrel{\\char`\u225f}}'),
      Pr('\u27c2', '\\perp'),
      Pr('\u203c', '\\mathclose{!\\mkern-0.8mu!}'),
      Pr('\u220c', '\\notni'),
      Pr('\u231c', '\\ulcorner'),
      Pr('\u231d', '\\urcorner'),
      Pr('\u231e', '\\llcorner'),
      Pr('\u231f', '\\lrcorner'),
      Pr('\xa9', '\\copyright'),
      Pr('\xae', '\\textregistered'),
      Pr('\ufe0f', '\\textregistered'),
      Pr('\\ulcorner', '\\html@mathml{\\@ulcorner}{\\mathop{\\char"231c}}'),
      Pr('\\urcorner', '\\html@mathml{\\@urcorner}{\\mathop{\\char"231d}}'),
      Pr('\\llcorner', '\\html@mathml{\\@llcorner}{\\mathop{\\char"231e}}'),
      Pr('\\lrcorner', '\\html@mathml{\\@lrcorner}{\\mathop{\\char"231f}}'),
      Pr('\\vdots', '\\mathord{\\varvdots\\rule{0pt}{15pt}}'),
      Pr('\u22ee', '\\vdots'),
      Pr('\\varGamma', '\\mathit{\\Gamma}'),
      Pr('\\varDelta', '\\mathit{\\Delta}'),
      Pr('\\varTheta', '\\mathit{\\Theta}'),
      Pr('\\varLambda', '\\mathit{\\Lambda}'),
      Pr('\\varXi', '\\mathit{\\Xi}'),
      Pr('\\varPi', '\\mathit{\\Pi}'),
      Pr('\\varSigma', '\\mathit{\\Sigma}'),
      Pr('\\varUpsilon', '\\mathit{\\Upsilon}'),
      Pr('\\varPhi', '\\mathit{\\Phi}'),
      Pr('\\varPsi', '\\mathit{\\Psi}'),
      Pr('\\varOmega', '\\mathit{\\Omega}'),
      Pr('\\substack', '\\begin{subarray}{c}#1\\end{subarray}'),
      Pr(
        '\\colon',
        '\\nobreak\\mskip2mu\\mathpunct{}\\mathchoice{\\mkern-3mu}{\\mkern-3mu}{}{}{:}\\mskip6mu\\relax',
      ),
      Pr('\\boxed', '\\fbox{$\\displaystyle{#1}$}'),
      Pr('\\iff', '\\DOTSB\\;\\Longleftrightarrow\\;'),
      Pr('\\implies', '\\DOTSB\\;\\Longrightarrow\\;'),
      Pr('\\impliedby', '\\DOTSB\\;\\Longleftarrow\\;'));
    var Gn = {
      ',': '\\dotsc',
      '\\not': '\\dotsb',
      '+': '\\dotsb',
    ...
    (Pr('\\dotso', function (e) {
      ...
      Pr('\\DOTSB', '\\relax'),
      Pr('\\DOTSX', '\\relax'),
      Pr('\\tmspace', '\\TextOrMath{\\kern#1#3}{\\mskip#1#2}\\relax'),
      Pr('\\,', '\\tmspace+{3mu}{.1667em}'),
      Pr('\\thinspace', '\\,'),
      Pr('\\>', '\\mskip{4mu}'),
      Pr('\\:', '\\tmspace+{4mu}{.2222em}'),
      Pr('\\medspace', '\\:'),
      Pr('\\;', '\\tmspace+{5mu}{.2777em}'),
      Pr('\\thickspace', '\\;'),
      Pr('\\!', '\\tmspace-{3mu}{.1667em}'),
      Pr('\\negthinspace', '\\!'),
      ...
      Pr('\\enspace', '\\kern.5em '),
      Pr('\\enskip', '\\hskip.5em\\relax'),
      Pr('\\quad', '\\hskip1em\\relax'),
      Pr('\\qquad', '\\hskip2em\\relax'),
      Pr('\\tag', '\\@ifstar\\tag@literal\\tag@paren'),
      Pr('\\tag@paren', '\\tag@literal{({#1})}'),
      Pr('\\tag@literal', function (e) {
      ...
      Pr('\\pod', '\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern8mu}{\\mkern8mu}{\\mkern8mu}(#1)'),
      Pr('\\pmod', '\\pod{{\\rm mod}\\mkern6mu#1}'),
      Pr(
        '\\mod',
    ...
    (Pr(
      ...
      Pr('\\hspace', '\\@ifstar\\@hspacer\\@hspace'),
      Pr('\\@hspace', '\\hskip #1\\relax'),
      Pr('\\@hspacer', '\\rule{0pt}{0pt}\\hskip #1\\relax'),
      Pr('\\ordinarycolon', ':'),
      Pr('\\vcentcolon', '\\mathrel{\\mathop\\ordinarycolon}'),
      Pr(
        '\\dblcolon',
      ...
      Pr('\u2a74', '\\Coloneqq'),
      Pr('\\ratio', '\\vcentcolon'),
      Pr('\\coloncolon', '\\dblcolon'),
      Pr('\\colonequals', '\\coloneqq'),
      Pr('\\coloncolonequals', '\\Coloneqq'),
      Pr('\\equalscolon', '\\eqqcolon'),
      Pr('\\equalscoloncolon', '\\Eqqcolon'),
      Pr('\\colonminus', '\\coloneq'),
      Pr('\\coloncolonminus', '\\Coloneq'),
      Pr('\\minuscolon', '\\eqcolon'),
      Pr('\\minuscoloncolon', '\\Eqcolon'),
      Pr('\\coloncolonapprox', '\\Colonapprox'),
      Pr('\\coloncolonsim', '\\Colonsim'),
      Pr('\\simcolon', '\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon}'),
      Pr('\\simcoloncolon', '\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\dblcolon}'),
      Pr('\\approxcolon', '\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\vcentcolon}'),
      Pr('\\approxcoloncolon', '\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\dblcolon}'),
      Pr('\\notni', '\\html@mathml{\\not\\ni}{\\mathrel{\\char`\u220c}}'),
      Pr('\\limsup', '\\DOTSB\\operatorname*{lim\\,sup}'),
      Pr('\\liminf', '\\DOTSB\\operatorname*{lim\\,inf}'),
      Pr('\\injlim', '\\DOTSB\\operatorname*{inj\\,lim}'),
      Pr('\\projlim', '\\DOTSB\\operatorname*{proj\\,lim}'),
      Pr('\\varlimsup', '\\DOTSB\\operatorname*{\\overline{lim}}'),
      Pr('\\varliminf', '\\DOTSB\\operatorname*{\\underline{lim}}'),
      Pr('\\varinjlim', '\\DOTSB\\operatorname*{\\underrightarrow{lim}}'),
      Pr('\\varprojlim', '\\DOTSB\\operatorname*{\\underleftarrow{lim}}'),
      Pr('\\gvertneqq', '\\html@mathml{\\@gvertneqq}{\u2269}'),
      Pr('\\lvertneqq', '\\html@mathml{\\@lvertneqq}{\u2268}'),
      ...
      Pr('\\varsubsetneq', '\\html@mathml{\\@varsubsetneq}{\u228a}'),
      Pr('\\varsubsetneqq', '\\html@mathml{\\@varsubsetneqq}{\u2acb}'),
      Pr('\\varsupsetneq', '\\html@mathml{\\@varsupsetneq}{\u228b}'),
      Pr('\\varsupsetneqq', '\\html@mathml{\\@varsupsetneqq}{\u2acc}'),
      Pr('\\imath', '\\html@mathml{\\@imath}{\u0131}'),
      Pr('\\jmath', '\\html@mathml{\\@jmath}{\u0237}'),
      Pr('\\llbracket', '\\html@mathml{\\mathopen{[\\mkern-3.2mu[}}{\\mathopen{\\char`\u27e6}}'),
      Pr('\\rrbracket', '\\html@mathml{\\mathclose{]\\mkern-3.2mu]}}{\\mathclose{\\char`\u27e7}}'),
      Pr('\u27e6', '\\llbracket'),
      Pr('\u27e7', '\\rrbracket'),
      Pr('\\lBrace', '\\html@mathml{\\mathopen{\\{\\mkern-3.2mu[}}{\\mathopen{\\char`\u2983}}'),
      Pr('\\rBrace', '\\html@mathml{\\mathclose{]\\mkern-3.2mu\\}}}{\\mathclose{\\char`\u2984}}'),
      Pr('\u2983', '\\lBrace'),
      Pr('\u2984', '\\rBrace'),
      Pr(
        '\\minuso',
      ...
      Pr('\\Complex', '\\mathbb{C}'),
      Pr('\\Dagger', '\\ddagger'),
      Pr('\\diamonds', '\\diamondsuit'),
      Pr('\\empty', '\\emptyset'),
      Pr('\\Epsilon', '\\mathrm{E}'),
      Pr('\\Eta', '\\mathrm{H}'),
      Pr('\\exist', '\\exists'),
      Pr('\\harr', '\\leftrightarrow'),
      Pr('\\hArr', '\\Leftrightarrow'),
      Pr('\\Harr', '\\Leftrightarrow'),
      Pr('\\hearts', '\\heartsuit'),
      Pr('\\image', '\\Im'),
      ...
      Pr('\\weierp', '\\wp'),
      Pr('\\Zeta', '\\mathrm{Z}'),
      Pr('\\argmin', '\\DOTSB\\operatorname*{arg\\,min}'),
      Pr('\\argmax', '\\DOTSB\\operatorname*{arg\\,max}'),
      Pr('\\plim', '\\DOTSB\\mathop{\\operatorname{plim}}\\limits'),
      Pr('\\bra', '\\mathinner{\\langle{#1}|}'),
      Pr('\\ket', '\\mathinner{|{#1}\\rangle}'),
      Pr('\\braket', '\\mathinner{\\langle{#1}\\rangle}'),
      Pr('\\Bra', '\\left\\langle#1\\right|'),
      Pr('\\Ket', '\\left|#1\\right\\rangle'));
    var Xn = function (e) {
      return function (t) {
        ...
        var l = function (t) {
          return function (r) {
            ...
            var i = t;
            !t && a.length && '|' === r.future().text && (r.popToken(), (i = !0));
            return { tokens: i ? a : n, numArgs: 0 };
          };
        };
    ...
    (Pr('\\bra@ket', Xn(!1)),
      ...
      Pr('\\set', '\\bra@set{\\{\\,}{\\mid}{}{\\,\\}}'),
      Pr('\\angln', '{\\angl n}'),
      Pr('\\blue', '\\textcolor{##6495ed}{#1}'),
      Pr('\\orange', '\\textcolor{##ffa500}{#1}'),
      Pr('\\pink', '\\textcolor{##ff00af}{#1}'),
      Pr('\\red', '\\textcolor{##df0030}{#1}'),
      Pr('\\green', '\\textcolor{##28ae7b}{#1}'),
      Pr('\\gray', '\\textcolor{gray}{#1}'),
      Pr('\\purple', '\\textcolor{##9d38bd}{#1}'),
      Pr('\\blueA', '\\textcolor{##ccfaff}{#1}'),
      Pr('\\blueB', '\\textcolor{##80f6ff}{#1}'),
      Pr('\\blueC', '\\textcolor{##63d9ea}{#1}'),
      Pr('\\blueD', '\\textcolor{##11accd}{#1}'),
      Pr('\\blueE', '\\textcolor{##0c7f99}{#1}'),
      Pr('\\tealA', '\\textcolor{##94fff5}{#1}'),
      Pr('\\tealB', '\\textcolor{##26edd5}{#1}'),
      Pr('\\tealC', '\\textcolor{##01d1c1}{#1}'),
      Pr('\\tealD', '\\textcolor{##01a995}{#1}'),
      Pr('\\tealE', '\\textcolor{##208170}{#1}'),
      Pr('\\greenA', '\\textcolor{##b6ffb0}{#1}'),
      Pr('\\greenB', '\\textcolor{##8af281}{#1}'),
      Pr('\\greenC', '\\textcolor{##74cf70}{#1}'),
      Pr('\\greenD', '\\textcolor{##1fab54}{#1}'),
      Pr('\\greenE', '\\textcolor{##0d923f}{#1}'),
      Pr('\\goldA', '\\textcolor{##ffd0a9}{#1}'),
      Pr('\\goldB', '\\textcolor{##ffbb71}{#1}'),
      Pr('\\goldC', '\\textcolor{##ff9c39}{#1}'),
      Pr('\\goldD', '\\textcolor{##e07d10}{#1}'),
      Pr('\\goldE', '\\textcolor{##a75a05}{#1}'),
      Pr('\\redA', '\\textcolor{##fca9a9}{#1}'),
      Pr('\\redB', '\\textcolor{##ff8482}{#1}'),
      Pr('\\redC', '\\textcolor{##f9685d}{#1}'),
      Pr('\\redD', '\\textcolor{##e84d39}{#1}'),
      Pr('\\redE', '\\textcolor{##bc2612}{#1}'),
      Pr('\\maroonA', '\\textcolor{##ffbde0}{#1}'),
      Pr('\\maroonB', '\\textcolor{##ff92c6}{#1}'),
      Pr('\\maroonC', '\\textcolor{##ed5fa6}{#1}'),
      Pr('\\maroonD', '\\textcolor{##ca337c}{#1}'),
      Pr('\\maroonE', '\\textcolor{##9e034e}{#1}'),
      Pr('\\purpleA', '\\textcolor{##ddd7ff}{#1}'),
      Pr('\\purpleB', '\\textcolor{##c6b9fc}{#1}'),
      Pr('\\purpleC', '\\textcolor{##aa87ff}{#1}'),
      Pr('\\purpleD', '\\textcolor{##7854ab}{#1}'),
      Pr('\\purpleE', '\\textcolor{##543b78}{#1}'),
      Pr('\\mintA', '\\textcolor{##f5f9e8}{#1}'),
      Pr('\\mintB', '\\textcolor{##edf2df}{#1}'),
      Pr('\\mintC', '\\textcolor{##e0e5cc}{#1}'),
      Pr('\\grayA', '\\textcolor{##f6f7f7}{#1}'),
      Pr('\\grayB', '\\textcolor{##f0f1f2}{#1}'),
      Pr('\\grayC', '\\textcolor{##e3e5e6}{#1}'),
      Pr('\\grayD', '\\textcolor{##d6d8da}{#1}'),
      Pr('\\grayE', '\\textcolor{##babec2}{#1}'),
      Pr('\\grayF', '\\textcolor{##888d93}{#1}'),
      Pr('\\grayG', '\\textcolor{##626569}{#1}'),
      Pr('\\grayH', '\\textcolor{##3b3e40}{#1}'),
      Pr('\\grayI', '\\textcolor{##21242c}{#1}'),
      Pr('\\kaBlue', '\\textcolor{##314453}{#1}'),
      Pr('\\kaGreen', '\\textcolor{##71B307}{#1}'));
    var Wn = { '^': !0, _: !0, '\\limits': !0, '\\nolimits': !0 },
      _n = (function () {
        function e(e, t, r) {
          ((this.settings = void 0),
            ...
            this.feed(e),
            (this.macros = new Dn(Vn, t.macros)),
            (this.mode = r),
            (this.stack = []));
        }
        var t = e.prototype;
        return (
          ...
          (t._getExpansion = function (e) {
            ...
            if ('string' == typeof n) {
              ...
              for (var o = new Ln(n, this.settings), s = [], l = o.lex(); 'EOF' !== l.text; )
                (s.push(l), (l = o.lex()));
          ...
          (t.isExpandable = function (e) {
            ...
            return null != t
              ...
              : qn.hasOwnProperty(e) && !qn[e].primitive;
          }),
          e
        );
      })(),
      ...
      Jn = (function () {
        function e(e, t) {
          ((this.mode = void 0),
            ...
            (this.mode = 'math'),
            (this.gullet = new _n(e, t, this.mode)),
            (this.settings = t),
        ...
        return (
          ...
          (t.parseExpression = function (t, r) {
            for (var n = []; ; ) {
              ...
              if (r && a.text === r) break;
              if (t && qn[a.text] && qn[a.text].infix) break;
